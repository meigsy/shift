...
CREATE OR REPLACE VIEW ${var.project_id}.shift_data.v_state_estimator_input_v1 AS
...
CREATE OR REPLACE VIEW ${var.project_id}.shift_data.v_state_estimator_unprocessed_v1 AS
WITH cte_input AS (
    SELECT
        user_id,
        timestamp,
        ...
        steps_value,
        raw_payload
    FROM ${var.project_id}.shift_data.v_state_estimator_input_v1
    --*************************************************************************************
...
LEFT JOIN ${var.project_id}.shift_data.state_estimates output
